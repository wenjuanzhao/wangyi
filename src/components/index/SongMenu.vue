<template>
  ...
  <div class="my-list-component">
      ...
      <div class="top-banner clearfix">
          ...
          <div class="top-right">
            <h2 class="title">
              <i class="icon icon-king" style="margin: 0"></i>{{title}}<i class="icon icon-arrow-right"></i>
            </h2>
    ...
    <div class="song-nav clearfix">
      <div class=" allsong">全部歌单<i class="icon icon-arrow-right-sm" style="margin: 0"></i>
      </div>
...
<style>
  ...
  .allsong{border:1px solid #ced0d0;border-radius: 0.5rem;padding:5px;width: 25%;float: left;line-height: 1;}
